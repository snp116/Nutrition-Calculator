  ...
  return {
    addTopping: function(toppingCal) {
      totalCalorie += toppingCal;
			sandwichEl.innerHTML = totalCalorie; 
...
coldChooser.addEventListener("click", function(event) {
  ...
  if (selectedTopping[0] === "btn"){
    ...
    console.log("We selected: ",selectedTopping[1], "at $",coldH[coldHKey]);   
...
hotChooser.addEventListener("click", function(event) {
  ...
  if (selectedTopping[0] === "btn"){
    ...
    console.log("We selected: ",selectedTopping[1], "at $",hotH[hotHKey]);
    console.log("finalHoagieCal",finalHoagieCal );
  }
});
...
toppingChooser.addEventListener("click", function(event) {
  ...
  if (selectedTopping[0] === "btn"){
    ...
    console.log("We selected: ",selectedTopping[1], "at $",topping[toppingKey]);
    console.log("finalHoagieCal",finalHoagieCal );
  }
});
